...
/**
 * A unit which can attack from the long range.
 */
public class RangedUnit extends Unit
{
     ...
     */
    public RangedUnit(int hp, int attack, int speed, int cost, int range, double trainingTimeSeconds)
    {
     ...
     * <p>
     *     If target is {@link AntiArmoredUnit}, the damage is multiply by {@code COUNTER_MULTIPLIER}.
     * </p>
    ...
    public int calculateDamage(Attackable target)
    {
        ...
        if (target instanceof AntiArmoredUnit)
        {
